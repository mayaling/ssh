            ...
            <div class="container">
                ...
                <div class="mgb20">
                        <el-row :gutter="10" class="clearfix">
                                <el-col :span="2">
                                <el-select v-model="region" placeholder="请选择渠道">
                                        <el-option label="区域一" value="shanghai"></el-option>
                                        <el-option label="区域二" value="beijing"></el-option>
                                      </el-select>
                                    </el-col>
                                    <el-col :span="2">
                             <el-select v-model="region" placeholder="请选择激活状态">
                                    <el-option label="区域一" value="shanghai"></el-option>
                                    <el-option label="区域二" value="beijing"></el-option>
                                  </el-select>
                                </el-col>
                            ...
                            <el-col :span="2"><el-input v-model.trim="s_klass" placeholder="输入用户手机号" @keyup.enter.native="search"></el-input></el-col>
